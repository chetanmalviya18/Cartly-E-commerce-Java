...
public class CategoryServlet extends HttpServlet {
    ...
    protected void doPost(
		...
		try {
			CategoryRequest categoryRequest = objectMapper.readValue(request.getReader(), CategoryRequest.class);
			
			CategoryResponse category = categoryService.createCategory(categoryRequest.getName(), categoryRequest.getDescription());
